...
namespace Joy\VoyagerBreadLocation\Models;
...
use Joy\VoyagerBreadLocation\Database\Factories\LocationFactory;
...
class Location extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Location'));
    }
